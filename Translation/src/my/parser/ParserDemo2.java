  ...
  public static void main(String[] args) throws IOException {
    ...
    if (args.length > 1) {
     ...
     // String[] sent = { "This", "is", "an", "easy", "sentence", "." };
    	...
    	String mystr="We went to street market to enjoy traditional foods.";
      ...
      String sent2 = ("Among the fruits, I like most the apple and mango. ");
    ...
    for (List<? extends HasWord> sentence : sentences) {
      ...
      String my_dependencytre=parse.pennString();
      
      Tree[] td=parse.children();
